...
public:
  ...
  unsigned __int128 mod_mul(unsigned __int128 a, unsigned __int128 b,
                            unsigned __int128 mod) {
    return (a * b) % mod;
  }

  unsigned __int128 mod_exp(unsigned __int128 base, unsigned __int128 exp,
                            unsigned __int128 mod) {
  ...
  unsigned __int128 decrypt(unsigned __int128 c) { return mod_exp(c, d, n); }
};
...
public:
  ...
  void compute_public_key() { public_key = mod_exp(g, private_key, p); }
